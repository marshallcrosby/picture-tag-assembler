...
if (pictureTagAssemblerScriptTag) {
    ...
    ptaParams = {
        ...
        defaultImageService: pictureTagAssemblerURLParam.get('placeholder-service')
    }
}
...
let ptaImageService = (ptaParams.defaultImageService) ? ptaParams.defaultImageService : 'none';
